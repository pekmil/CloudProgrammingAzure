...
using AzureTodoWebApplication1.Services;
...
namespace AzureTodoWebApplication1.Controllers
{
    public class TodosController : Controller
    {
        ...
        public TodosController(TodoDbContext context, IStorageService storageService, IQueueService queueService, IGoogleCloudService googleCloudService)
        {
            _context = context;
